...
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('Marathon', 'c_marathon', 26, 29, 'marathon');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('50k', 'c_50k', 29, 48, 'ultra');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('50mi', 'c_50mi', 48, 58, 'ultra');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('100k', 'c_100k', 58, 68, 'ultra');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('100k+', 'c_100kplus', 68, 98, 'ultra');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('100mi', 'c_100mi', 98, 110, 'ultra');
INSERT INTO `run_class` (`name`, `key`, `min`, `max`, `parent`)
values ('Xtreme', 'c_xtreme', 110, 1000, 'ultra');
